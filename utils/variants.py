...
🔹 Название:[Data Engineer/BI-аналитик]
📌 Категория позиции:[Выбор из списка]
🏢 Компания:[Название + ссылка на сайт/карьерную страницу]
🧑‍💻 Уровень:[Junior | Junior+ | Middle | Senior | Lead]

🌍 Локация:[РФ | Казахстан | Беларусь | Международная]
🕕 Часовой пояс:[МСК+3 | UTC+6 и т.д.]
💼 Формат работы:[✅ Удалённо | 🏢 Офис | 🔄 Гибрид]

💰 Зарплата:[200 000 - 250 000 ₽ Gross | от 3000$ Net] * обязательно указать тип *

📊 Предметная область:
[Выбор из списка]

🎯 Ключевые требования:
•[Опыт работы с  от 2 лет]
•[Знание  на уровне]
•[Готовность к]
...
📌 Условия:
✅[ДМС | Обучение | Релокейт]
⚠️[Испытательный срок | Командировки]

📩 Контакты:
[@ telegram | email @ domain.com | +7 (XXX) XXX - XX - XX]

ℹ️ Дополнительно:
[Сайт компании | Этапы собеседования | Особые условия]

🏷 Теги:  #[Профессия] #[Город] #[ФорматРаботы] (Генерируются автоматически)
""")
